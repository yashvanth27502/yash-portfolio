...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: 'Phone',
    description: '(+91) 6364427502',
  },
  {
    icon: <FaEnvelope />,
    title: 'email',
    description: 'yashvanth27502@gmail.com',
  },
  {
    icon: <FaMapMarkerAlt />,
    title: 'Address',
        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse similique quibusdam quasi laborum sit iste.</p>
              {/* input */}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="dst">Digital Marketing</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* tetxtarea */}
